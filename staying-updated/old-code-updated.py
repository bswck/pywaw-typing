...
class Level:
    ...
    @classmethod
    def get(cls, level_id: int) -> Level | None:
...
class Task:
    ...
    def random(
        cls,
        operand_range: tuple[int, int] | None = None,
...
class App:
    def __init__(
        ...
        done_tasks: collections.deque[Task] = collections.deque(),
    ...
    @staticmethod
    def _handle_level_choice(answer: str) -> tuple[ResultStatus, Level | None]:
        try:
            res = int(answer)
