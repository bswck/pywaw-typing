# I just learnt about typing.NamedTuple
# ruff check gradual-introduction/old-code.py --select=PYI024
...
class IntegralSquares(Level, id=2):
    ...
    _range = (11, 29)
    _operations = {"": operation_schema(lambda x: x**2, range(1))}
...
class Comms:
    ...
    def input(self, message=None, text=None, handler=None, reenter_message_repeat=True):
